  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      .handout-heading { display: grid; gap: 2mm; }
      ...
      @media print {
        ...
        .handout-page { margin: 0; width: calc(210mm - 16mm); min-width: calc(210mm - 16mm); max-width: calc(210mm - 16mm); height: calc(297mm - 16mm); min-height: calc(297mm - 16mm); max-height: calc(297mm - 16mm); }
      }
    </style>
  </head>
  <body>
